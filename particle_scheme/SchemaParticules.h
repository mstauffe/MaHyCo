 ...
 public:
  SchemaParticules(
      ...
      : mesh(aCartesianMesh2D),
        ...
        nbPart(acstmesh->Nombre_Particules),
        m_particle_volume("particle_volume", nbPart),
        m_particle_weight("particle_weight", nbPart),
        m_particle_mass("particle_mass", nbPart),
        m_particle_radius("particle_radius", nbPart),
        m_particle_density("particle_density", nbPart),
        m_particle_reynolds("particle_reynolds", nbPart),
        m_particle_drag("particle_drag", nbPart),
        m_particle_mac("particle_drag", nbPart),
        m_cell_particle_list("listepart", nbCells),
        m_cell_particle_volume_fraction("fracPart", nbCells),
        m_particle_coord_n0("particle_coord_n0", nbPart),
        m_particle_coord_n("particle_coord_n", nbPart),
        m_particle_coord_nplus1("particle_coord_nplus1", nbPart),
        m_particle_velocity_n0("particle_velocity_n0", nbPart),
        m_particle_velocity_n("particle_velocity_n", nbPart),
        m_particle_velocity_nplus1("particle_velocity_nplus1", nbPart),
        m_particle_cell("Icellp", nbPart),
        m_particle_env("Imatp", nbPart),
        m_particlecell_fracvol_env("fracvol_env", nbCells),
        m_particlecell_fracvol_gradient_env("fracvol_gradient_env", nbCells,
                                            nbmatmax),
        ...
        m_particlecell_pressure_gradient("particle_pressure_gradient",
                                         nbCells) {}
