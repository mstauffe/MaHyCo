 ...
 * In variables: NohTestCase, SedovTestCase, SodCase, m_cell_coord_n0, testCase
 * Out variables: m_cell_velocity_n0
 */
void Initialisations::initCellVelocity() noexcept {
  Kokkos::parallel_for(
 ...
 * In variables: SodCase, m_cell_coord_n0, testCase
 * Out variables: m_density_n0, m_fracvol_env_n0, m_mass_fraction_env_n0
 */
void Initialisations::initDensity() noexcept {
