 ...
 * Out variables: c, p
 */
void VnrRemap::computeEOSGP(int imat)  {
	Kokkos::parallel_for(nbCells, KOKKOS_LAMBDA(const size_t& cCells)
	{
 ...
 * Out variables: c, p
 */
void VnrRemap::computeEOSVoid(int imat) {
 ...
 * Out variables: c, p
 */
void VnrRemap::computeEOSSTIFG(int imat) {
  Kokkos::parallel_for("computeEOS", nbCells, KOKKOS_LAMBDA(const int& cCells) {
 ...
 * Out variables: c, p
 */
void VnrRemap::computeEOSMur(int imat) {
  Kokkos::parallel_for("computeEOS", nbCells, KOKKOS_LAMBDA(const int& cCells) {
    std::cout << " Pas encore programmée" << std::endl;
  });
}
 ...
 * Out variables: c, p
 */
void VnrRemap::computeEOSSL(int imat) {
  Kokkos::parallel_for("computeEOS", nbCells, KOKKOS_LAMBDA(const int& cCells) {
    std::cout << " Pas encore programmée" << std::endl;
  });
}
 ...
 * Job computeEOS called in executeTimeLoopN method.
 */
void VnrRemap::computePressionMoyenne() noexcept {
